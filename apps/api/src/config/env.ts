...
export const env = {
  ...
  feedServiceEnabled: optional("FEED_SERVICE_ENABLED", "false") === "true",
  feedServiceUrl: optional("FEED_SERVICE_URL", "localhost:50051"),
  feedServiceTimeoutMs: optionalNumber("FEED_SERVICE_TIMEOUT_MS", 250),
